...
const I18N = {
  es: {
    ...
    'vs.challengedYou': 'te retó a un 1v1',
    ...
    'versus.friendly': 'Versus Amistoso (testing)', 'versus.friendlyDesc': 'Juega con amigos o gente al azar',
    ...
    'lobby.joinByCode': 'Unirse con un código', 'lobby.join': 'Unirse',
    ...
    'lobby.players': 'jugadores', 'lobby.roomOf': 'Sala de', 'lobby.loading': 'Cargando salas…',
    'lobby.joinError': 'No se pudo unir a la sala', 'lobby.createError': 'No se pudo crear la sala',
    'lobby.kicked': 'Te expulsaron de la sala', 'lobby.closed': 'El host cerró la sala',
  ...
  en: {
    ...
    'vs.challengedYou': 'challenged you to a 1v1',
    ...
    'versus.friendly': 'Friendly Versus (testing)', 'versus.friendlyDesc': 'Play with friends or random people',
    ...
    'lobby.joinByCode': 'Join with a code', 'lobby.join': 'Join',
    ...
    'lobby.players': 'players', 'lobby.roomOf': "Room of", 'lobby.loading': 'Loading rooms…',
    'lobby.joinError': 'Could not join the room', 'lobby.createError': 'Could not create the room',
    'lobby.kicked': 'You were kicked from the room', 'lobby.closed': 'The host closed the room',
