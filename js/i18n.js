...
const I18N = {
  es: {
    ...
    'panel2.globequizDesc': 'Adivina el país misterioso del día. Cada intento fallido marca el globo: mientras más caliente el color, más cerca estás.',
    'panel2.globequizDescPlayed': 'Vuelve mañana por un país nuevo. ¡Mientras tanto, juega las veces que quieras para practicar!',
    'panel2.globequizNextDayLabel': 'Nuevo día en',
    'globequiz.inputPh': 'Escribe un país...', 'globequiz.guessBtn': 'Adivinar',
    'globequiz.notFound': 'País no reconocido', 'globequiz.alreadyGuessed': 'Ya lo intentaste',
    'globequiz.loadError': 'No se pudo cargar el globo 3D. Recarga la página o probá con otro navegador.',
    'globequiz.loadErrorWebgl': 'Tu navegador tiene WebGL desactivado (común en LibreWolf, Tor Browser o modo de privacidad estricto). Habilitá WebGL para este sitio en la configuración de permisos, o probá con otro navegador.',
    'globequiz.win': '¡Correcto! Lo lograste en {n} intentos.',
    'globequiz.correctBadge': 'País correcto',
    'globequiz.lockedNoAccount': 'Necesitas una cuenta para jugar GloboReto.',
    'globequiz.lockedNoCampaign': 'Juega una Gira Mundial completa primero para desbloquear GloboReto.',
    'globequiz.gameOverTitle': '¡Juego terminado!',
    'globequiz.timeTaken': 'Tiempo',
    'globequiz.attempts': 'Intentos',
    'globequiz.didYouMean': '¿Quisiste decir',
    'globequiz.clickToFocus': 'Click para centrar el globo en este país',
    'globequiz.guessListTitle': 'Países que ya escribiste',
    'globequiz.hintFirst': 'Coloca el nombre del país de tu primera opción.',
    'globequiz.hintStart': 'Arrastra, clickea y haz zoom en el globo para que te ayude a escoger tu próxima opción.',
    'globequiz.hintBorders': '{name} limita con tu selección.',
    'globequiz.hintHotter': '{name} está más caliente.',
    'globequiz.hintColder': '{name} está más frío.',
    'globequiz.hintCorrect': 'El país correcto es {name}.',
    'globequiz.streakGainedTitle': '¡Felicidades, sumaste tu racha de hoy!',
    'globequiz.streakGainedSub': 'Vuelve mañana para seguir aumentando tu racha.',
    'globequiz.streakAlreadyTitle': 'Ya jugaste hoy y sumaste tu racha.',
    'globequiz.streakAlreadySub': 'Puedes seguir jugando, pero no sumará racha hasta mañana.',
    'globequiz.nextStreakIn': 'Próxima racha en',
    'panel2.globequizGreetPlayed1': '¡Ya jugaste hoy!',
    'panel2.globequizGreetPlayed2': 'Vuelve mañana para seguir tu racha.',
    ...
    'social.sendRequest': 'Enviar Solicitud', 'social.sending': 'Enviando Solicitud...',
    ...
    'social.loadingUsers': 'Cargando usuarios...', 'social.noData': 'Sin datos',
    ...
    'social.alreadySent': 'Ya le has enviado una solicitud',
    ...
    'vs.result.spectatorWins': '¡GANA {name}!', 'vs.result.abandonNeutral': 'El rival abandonó la partida',
    'vs.guestUnavailable': 'No está disponible ahora', 'vs.inviteExpired': 'El reto expiró sin respuesta',
    'vs.gqSyncFailed': 'No se pudo sincronizar el globo 3D con el rival. Prueben de nuevo.',
    ...
    'vs.challengedGlobequiz': 'te retó a GloboReto 1v1',
    'vs.chooseMode': '¿Qué modo quieren jugar?',
    'vs.duelAccepted': '¡Duelo aceptado! Redirigiéndote a la partida…',
    'vs.syncTitle': 'Sincronizando la partida…',
    'vs.syncStarting': '¡Empezando!',
    'vs.syncYou': 'Tú',
    ...
    'chat.send': 'Enviar',
    'chat.you': 'Tú: ',
    'chat.tabHistory': 'Historial',
    'chat.tabOnline': 'Conectados',
    'chat.tabAll': 'Todos',
    'chat.noPreview': 'Sin mensajes todavía',
    'chat.noConversations': 'Agrega amigos para empezar a chatear',
    'chat.noMessages': 'Todavía no hay mensajes. ¡Saluda!',
    ...
    'customize.catLeaderboard': 'Viñetas',
    'customize.catTable': 'Paneles',
    'customize.catCell': 'Celdas',
    'customize.optDefault': 'Predeterminado',
    'customize.locked': 'Disponible solo para los primeros 100 jugadores registrados.',
    'customize.frameFounder': 'Fundador',
    'founderPopup.title': '¡Eres Fundador!',
    'founderPopup.desc': 'Por ser una de las primeras 100 cuentas de myGeoChallenge, te regalamos un paquete exclusivo de personalización:',
    'founderPopup.itemFrame': 'Marco',
    ...
    'account.errUserChars': 'Entre 4 y 12 caracteres.', 'account.errUserInvalid': 'Solo letras y números.', 'account.errUserBadWord': 'Ese nombre no está permitido.', 'account.errEmailInvalid': 'Correo inválido.',
    'account.changeUsername': 'Cambiar nombre de usuario', 'account.changeUsernameTitle': 'Cambiar nombre de usuario',
    'account.newUsername': 'Nuevo nombre de usuario', 'account.changeUsernameBtn': 'Cambiar',
    'account.changeUsernameConfirmTitle': '¿Confirmar cambio?', 'account.changeUsernameConfirmYes': 'Sí, cambiar',
    'account.changeUsernameConfirmDesc': '¿Seguro que quieres cambiar tu nombre de usuario a "{name}"? Solo vas a poder volver a cambiarlo dentro de 30 días.',
    'account.changeUsernameOkTitle': '¡Nombre actualizado!', 'account.changeUsernameOkDesc': 'Tu nombre de usuario ahora es "{name}".',
    'account.errSameUsername': 'Ese ya es tu nombre de usuario actual.', 'account.errUserTaken': 'Ese nombre de usuario ya está en uso.',
    'account.errUsernameCooldown.one': 'Ya cambiaste tu nombre de usuario hace poco. Podrás volver a hacerlo en {n} día.',
    'account.errUsernameCooldown.other': 'Ya cambiaste tu nombre de usuario hace poco. Podrás volver a hacerlo en {n} días.',
    'account.errGeneric': 'Ocurrió un error. Intenta de nuevo.',
    'account.errPassShort': 'Mínimo 6 caracteres.', 'account.errPassMismatch': 'Las contraseñas no coinciden.',
    'account.errPassContainsUser': 'La contraseña no puede contener tu nombre de usuario.',
    ...
    'account.forgotTitle': 'Recuperar contraseña', 'account.forgotBtn': 'Enviar código', 'account.back': 'Volver',
    'account.forgotSentTitle': 'Revisa tu correo', 'account.forgotSentDesc': 'Te enviamos un enlace para restablecer tu contraseña.',
    'account.forgotCodeTitle': 'Revisa tu correo', 'account.forgotCodeDesc': 'Te enviamos un código de verificación a tu correo.',
    'account.code': 'Código', 'account.forgotCodeBtn': 'Verificar', 'account.resendCode': 'Reenviar código',
    'account.errCodeInvalid': 'Código inválido o expirado.', 'account.codeResent': 'Código reenviado.',
    ...
    'spectator.idle': '{name} está en otra parte del juego...',
    'spectator.failedToOpen': 'No se pudo abrir la partida.',
    'spectator.finished': '¡{name} terminó la partida!',
    'spectator.left': '{name} dejó de jugar',
    'spectator.roomEmpty': 'La sala se vació',
    'spectator.watchingTag': 'ESPECTANDO',
    'spectator.watchingFriend': 'Mirando a {name}',
  ...
  en: {
    ...
    'panel2.globequizGreet1': 'A new country every day!', 'panel2.globequizGreet2': 'Ready to find it?',
    'panel2.globequizTitle': 'GlobeQuiz',
    'panel2.globequizDesc': "Guess today's mystery country. Each wrong guess marks the globe — the hotter the color, the closer you are.",
    'panel2.globequizDescPlayed': 'Come back tomorrow for a new country. Meanwhile, play as many times as you like to practice!',
    'panel2.globequizNextDayLabel': 'New day in',
    'globequiz.inputPh': 'Type a country...', 'globequiz.guessBtn': 'Guess',
    'globequiz.notFound': 'Country not recognized', 'globequiz.alreadyGuessed': 'Already tried that one',
    'globequiz.loadError': "Couldn't load the 3D globe. Reload the page or try another browser.",
    'globequiz.loadErrorWebgl': "Your browser has WebGL disabled (common in LibreWolf, Tor Browser, or strict privacy modes). Enable WebGL for this site in your permission settings, or try another browser.",
    'globequiz.win': 'Correct! You got it in {n} guesses.',
    'globequiz.correctBadge': 'Correct country',
    'globequiz.lockedNoAccount': 'You need an account to play GlobeQuiz.',
    'globequiz.lockedNoCampaign': 'Complete a full World Tour first to unlock GlobeQuiz.',
    'globequiz.gameOverTitle': 'Game over!',
    'globequiz.timeTaken': 'Time',
    'globequiz.attempts': 'Attempts',
    'globequiz.didYouMean': 'Did you mean',
    'globequiz.clickToFocus': 'Click to center the globe on this country',
    'globequiz.guessListTitle': 'Countries you\'ve already entered',
    'globequiz.hintFirst': 'Enter the name of your first guess country.',
    'globequiz.hintStart': 'Drag, click and zoom on the globe to help you pick your next guess.',
    'globequiz.hintBorders': '{name} borders your selection.',
    'globequiz.hintHotter': '{name} is warmer.',
    'globequiz.hintColder': '{name} is colder.',
    'globequiz.hintCorrect': 'The correct country is {name}.',
    'globequiz.streakGainedTitle': 'Congrats, you extended your streak today!',
    'globequiz.streakGainedSub': 'Come back tomorrow to keep growing your streak.',
    'globequiz.streakAlreadyTitle': 'You already played today and kept your streak.',
    'globequiz.streakAlreadySub': "You can keep playing, but it won't add to your streak until tomorrow.",
    'globequiz.nextStreakIn': 'Next streak in',
    'panel2.globequizGreetPlayed1': 'You already played today!',
    'panel2.globequizGreetPlayed2': 'Come back tomorrow to keep your streak.',
    ...
    'social.sendRequest': 'Send Request', 'social.sending': 'Sending Request...',
    ...
    'social.loadingUsers': 'Loading users...', 'social.noData': 'No data',
    ...
    'social.alreadySent': "You've already sent them a request",
    ...
    'splash.monuments.1': "OK, time for a little sightseeing! How's your knowledge of famous landmarks?",
    ...
    'vs.result.spectatorWins': '{name} WINS!', 'vs.result.abandonNeutral': 'The opponent left the match',
    'vs.guestUnavailable': 'Not available right now', 'vs.inviteExpired': 'The challenge expired',
    'vs.gqSyncFailed': "Couldn't sync the 3D globe with your opponent. Try again.",
    ...
    'vs.challengedGlobequiz': 'challenged you to GloboReto 1v1',
    'vs.chooseMode': 'What mode do you want to play?',
    'vs.duelAccepted': 'Duel accepted! Taking you to the match…',
    'vs.syncTitle': 'Syncing the match…',
    'vs.syncStarting': 'Starting!',
    'vs.syncYou': 'You',
    'vs.syncLoading': 'Loading…',
    'vs.syncAlmost': 'Almost ready…',
    'vs.syncReady': 'Ready!',
    ...
    'chat.send': 'Send',
    'chat.you': 'You: ',
    'chat.tabHistory': 'History',
    'chat.tabOnline': 'Online',
    'chat.tabAll': 'All',
    'chat.noPreview': 'No messages yet',
    'chat.noConversations': 'Add friends to start chatting',
    ...
    'guestPopup.title': 'Nice game, {name}!',
    ...
    'guestPopup.connectionError': "We couldn't connect to the servers. Please try again later.",
    // Customization (founder frame)
    'customize.title': 'Customization',
    'customize.btnLabel': 'Customize',
    'customize.catPhoto': 'Frames',
    'customize.catLeaderboard': 'Cards',
    'customize.catTable': 'Panels',
    'customize.catCell': 'Cells',
    'customize.optDefault': 'Default',
    'customize.locked': 'Only available to the first 100 registered players.',
    'customize.frameFounder': 'Founder',
    'founderPopup.title': "You're a Founder!",
    'founderPopup.desc': "As one of the first 100 accounts on myGeoChallenge, we're gifting you an exclusive customization pack:",
    'founderPopup.itemFrame': 'Frame',
    'founderPopup.itemCard': 'Card',
    'founderPopup.itemPanel': 'Panel',
    'founderPopup.itemCell': 'Cell',
    // Account
    'nav.account': 'Account',
    ...
    'account.errUserChars': 'Between 4 and 12 characters.', 'account.errUserInvalid': 'Letters and numbers only.', 'account.errUserBadWord': 'That name is not allowed.', 'account.errEmailInvalid': 'Invalid email.',
    'account.changeUsername': 'Change username', 'account.changeUsernameTitle': 'Change username',
    'account.newUsername': 'New username', 'account.changeUsernameBtn': 'Change',
    'account.changeUsernameConfirmTitle': 'Confirm change?', 'account.changeUsernameConfirmYes': 'Yes, change it',
    'account.changeUsernameConfirmDesc': 'Are you sure you want to change your username to "{name}"? You\'ll only be able to change it again in 30 days.',
    'account.changeUsernameOkTitle': 'Username updated!', 'account.changeUsernameOkDesc': 'Your username is now "{name}".',
    'account.errSameUsername': 'That\'s already your current username.', 'account.errUserTaken': 'That username is already taken.',
    'account.errUsernameCooldown.one': 'You changed your username recently. You can change it again in {n} day.',
    'account.errUsernameCooldown.other': 'You changed your username recently. You can change it again in {n} days.',
    ...
    'account.errPassContainsUser': 'Password can\'t contain your username.',
    ...
    'account.forgotTitle': 'Reset password', 'account.forgotBtn': 'Send code', 'account.back': 'Go back',
    'account.forgotSentTitle': 'Check your email', 'account.forgotSentDesc': 'We sent a link to reset your password.',
    'account.forgotCodeTitle': 'Check your email', 'account.forgotCodeDesc': 'We sent a verification code to your email.',
    'account.code': 'Code', 'account.forgotCodeBtn': 'Verify', 'account.resendCode': 'Resend code',
    'account.errCodeInvalid': 'Invalid or expired code.', 'account.codeResent': 'Code resent.',
    ...
    // Spectator mode
    'spectator.loading': 'Loading match...',
    'spectator.returning': 'Returning to menu...',
    'spectator.reconnecting': 'Reconnecting...',
    'spectator.idle': '{name} is somewhere else in the game...',
    'spectator.failedToOpen': "Couldn't open the match.",
    'spectator.finished': '{name} finished the match!',
    'spectator.left': '{name} stopped playing',
    'spectator.roomEmpty': 'The room emptied',
    'spectator.watchingTag': 'SPECTATING',
    'spectator.watchingFriend': 'Watching {name}',
    'spectator.watchingMatch': 'Watching match',
    'spectator.defaultPlayer': 'The player',
    'vs.waitingForOthers': 'Waiting for other players...',
