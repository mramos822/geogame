...
const I18N = {
  es: {
    ...
    'account.verifyTitle': '¡Casi listo!', 'account.verifyDesc': 'Tu cuenta necesita verificarse.<br>Revisa tu correo y haz click en el enlace de confirmación.',
    ...
    'account.changePassTitle': 'Cambiar contraseña', 'account.newPass': 'Nueva contraseña', 'account.confirmNewPass': 'Confirmar nueva contraseña', 'account.saveChanges': 'Guardar',
  ...
  en: {
    ...
    'account.verifyTitle': 'Almost there!', 'account.verifyDesc': 'Your account needs to be verified.<br>Check your email and click the confirmation link.',
    ...
    'account.changePassTitle': 'Change password', 'account.newPass': 'New password', 'account.confirmNewPass': 'Confirm new password', 'account.saveChanges': 'Save',
