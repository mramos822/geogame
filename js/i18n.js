...
const I18N = {
  es: {
    ...
    'globequiz.alreadyGuessedShared': 'Ya se intentó ese país',
    'gq.waitingTurnFor': 'Esperando respuesta de {name}...',
    'gq.afkKicked': 'Te desconectamos automáticamente por inactividad.',
    'gq.youTimedOut': 'No respondiste a tiempo',
    'gq.oppTimedOut': '{name} no ha respondido a tiempo',
    ...
    'globequiz.groupSomeoneSolved': '{name} ya adivinó el país!',
    'globequiz.groupRoundBadge': 'Ronda {round}/{total}',
    'globequiz.finalRoundBadge': 'Ronda Final',
    ...
    'globequiz.shareX': 'Compartir en Twitter/X',
    'gqGuestPopup.title': '¡No pierdas tu racha!',
    'gqGuestPopup.msg': 'Crea una cuenta para guardar tu racha de GloboReto, entrar al ranking y retar a tus amigos.',
    ...
    // Variantes "por turnos": los intentos de la lista son de CUALQUIERA de
    // los dos jugadores, no solo míos — nada de "tu" posesivo.
    'globequiz.hintFirstShared': 'Coloca el nombre del país de la primera opción.',
    'globequiz.hintStartShared': 'Arrastra, clickea y haz zoom en el globo para ayudar a escoger la próxima opción.',
    'globequiz.hintBordersShared': '{name} limita con la selección.',
    ...
    'streakRestore.title': '¡Perdiste tu racha!',
    'streakRestore.bodyRestorable': 'Tu racha de {n} días se rompió, pero todavía puedes recuperarla.',
    'streakRestore.deadline': 'Disponible hasta el {deadline}',
    'streakRestore.left': 'Recuperaciones disponibles este mes: {left} de 3',
    'streakRestore.btn': 'Recuperar racha',
    'streakRestore.dismiss': 'Ahora no',
    'streakRestore.bodyNoQuota': 'Tu racha de {n} días se rompió y ya usaste tus 3 recuperaciones de este mes. Juega GloboReto hoy para empezar una nueva racha.',
    'streakRestore.bodyExpired': 'Tu racha de {n} días se perdió para siempre: el plazo de recuperación terminó. Vuelve a jugar GloboReto para empezar una nueva.',
    'streakRestore.doneTitle': '¡Racha recuperada!',
    'streakRestore.doneBody': 'Tu racha de {n} días está de vuelta. Juega hoy para seguir sumando.',
    'streakRestore.error': 'No se pudo recuperar la racha. Inténtalo de nuevo.',
    ...
    'gqvr.title': 'Ronda terminada', 'gqvr.countryWas': 'El país era', 'gqvr.time': 'Tiempo',
    'gqvr.attempts': 'Intentos', 'gqvr.playAgain': 'Jugar de nuevo', 'gqvr.exit': 'Salir',
    'gqvr.win': '¡Ganaste!', 'gqvr.lose': 'Perdiste',
    'gqvr.rematch': 'Rematch?', 'gqvr.waitingRematch': 'Esperando respuesta',
    'gqvr.leftMatch': '{name} abandonó la partida', 'gqvr.loadingNew': 'Cargando nueva partida...',
    ...
    'vs.challengedGlobequizTurns': 'te retó a GloboReto (por turnos)',
    'vs.chooseMode': '¿Qué modo quieren jugar?',
    'vs.chooseGqVariant': '¿Cómo quieren jugar GloboReto?',
    'vs.gqSpeedTitle': 'Por rapidez',
    'vs.gqSpeedDesc': 'El más rápido en adivinar gana',
    'vs.gqTurnsTitle': 'Por turnos',
    'vs.gqTurnsDesc': 'El primero en adivinar gana',
    'gq.rouletteTitle': '¿Quién arranca?',
    'gq.rouletteYouStart': '¡Empiezas tú!',
    'gq.rouletteOppStarts': '{name} arranca',
    'gq.rouletteAgain': '¡Gira de nuevo!',
    'gq.myTurnNotice': '¡Es tu turno!',
    'gq.specFriendTurn': 'Le toca a {name}',
    'gq.specOppTurn': 'Le toca a {name}',
    'vs.waitingResponse': 'Esperando respuesta…',
    ...
    'chat.cooldown': 'Demasiados mensajes, esperá {secs}s',
    'chat.cooldownStart': 'Demasiados mensajes seguidos, esperá 10s',
    'chat.dayToday': 'Hoy',
    'chat.dayYesterday': 'Ayer',
    'chat.dayAgo': 'Hace {n} días',
    ...
    'lobby.disqualified': 'DESCALIFICADO',
    ...
    'lobby.globoretoWip': 'GloboReto grupal: en construcción',
    'lobby.syncTitle': 'Cargando partida...',
    'lobby.confirmSwitchRoom': 'Si te unís a otro grupo, saldrás de este. ¿Estás seguro?',
    'lobby.confirmLeaveHost': '¿Seguro que querés salir? El rol de host pasará a otro miembro.',
    'lobby.back': '← Volver', 'lobby.gqRounds': 'Rondas de la partida', 'lobby.gqTurnTime': 'Tiempo de respuesta',
    'lobby.gqSpeedName': 'Tiempo Real', 'lobby.gqTurnsName': 'Por Turnos',
    'lobby.gqInfoRounds': 'Rondas: {n}', 'lobby.gqInfoTurnTime': 'Tiempo: {n}s',
    ...
    'customize.frameExclusive': 'Top 1',
    ...
    'top1Popup.title': '¡Eres el nuevo Top 1!',
    'top1Popup.desc': 'Superaste a todos los jugadores de myGeoChallenge. Como recompensa, te regalamos un marco exclusivo que puedes usar mientras mantengas el primer puesto:',
    'top1Popup.itemFrame': 'Marco',
    'top1Lost.title': 'Perdiste el Top 1',
    'top1Lost.desc': 'Otro jugador te superó en el ranking. Sigue jugando para recuperar el primer puesto — al recuperarlo, el marco vuelve a estar disponible.',
    // Account
    'nav.account': 'Cuenta',
  ...
  en: {
    ...
    'globequiz.alreadyGuessedShared': 'That country was already tried',
    'gq.waitingTurnFor': "Waiting for {name}'s answer...",
    'gq.afkKicked': "You've been disconnected automatically for inactivity.",
    'gq.youTimedOut': "You didn't answer in time",
    'gq.oppTimedOut': "{name} hasn't answered in time",
    ...
    'globequiz.groupSomeoneSolved': '{name} already guessed the country!',
    'globequiz.groupRoundBadge': 'Round {round}/{total}',
    'globequiz.finalRoundBadge': 'Final Round',
    ...
    'globequiz.shareX': 'Share on Twitter/X',
    'gqGuestPopup.title': "Don't lose your streak!",
    'gqGuestPopup.msg': 'Create an account to save your GlobeQuiz streak, join the ranking and challenge your friends.',
    ...
    'streakRestore.title': 'You lost your streak!',
    'streakRestore.bodyRestorable': 'Your {n}-day streak was broken, but you can still get it back.',
    'streakRestore.deadline': 'Available until {deadline}',
    'streakRestore.left': 'Recoveries left this month: {left} of 3',
    'streakRestore.btn': 'Recover streak',
    'streakRestore.dismiss': 'Not now',
    'streakRestore.bodyNoQuota': 'Your {n}-day streak was broken and you already used your 3 recoveries this month. Play GloboReto today to start a new streak.',
    'streakRestore.bodyExpired': 'Your {n}-day streak is gone for good: the recovery window has passed. Play GloboReto again to start a new one.',
    'streakRestore.doneTitle': 'Streak recovered!',
    'streakRestore.doneBody': 'Your {n}-day streak is back. Play today to keep it growing.',
    'streakRestore.error': 'The streak could not be recovered. Please try again.',
    ...
    'gqvr.title': 'Round over', 'gqvr.countryWas': 'The country was', 'gqvr.time': 'Time',
    'gqvr.attempts': 'Guesses', 'gqvr.playAgain': 'Play again', 'gqvr.exit': 'Exit',
    'gqvr.win': 'You won!', 'gqvr.lose': 'You lost',
    'gqvr.rematch': 'Rematch?', 'gqvr.waitingRematch': 'Waiting for a response',
    'gqvr.leftMatch': '{name} left the match', 'gqvr.loadingNew': 'Loading new match...',
    ...
    'vs.challengedGlobequiz': 'challenged you to GlobeQuiz 1v1',
    'vs.challengedGlobequizTurns': 'challenged you to GlobeQuiz (turn-based)',
    'vs.chooseMode': 'What mode do you want to play?',
    'vs.chooseGqVariant': 'How do you want to play GlobeQuiz?',
    'vs.gqSpeedTitle': 'Speed',
    'vs.gqSpeedDesc': 'The fastest to guess wins',
    'vs.gqTurnsTitle': 'Turn-based',
    'vs.gqTurnsDesc': 'The first to guess wins',
    'gq.rouletteTitle': 'Who goes first?',
    'gq.rouletteYouStart': 'You go first!',
    'gq.rouletteOppStarts': '{name} goes first',
    'gq.rouletteAgain': 'Spin again!',
    'gq.myTurnNotice': "It's your turn!",
    'gq.specFriendTurn': "It's {name}'s turn",
    'gq.specOppTurn': "It's {name}'s turn",
    'vs.waitingResponse': 'Waiting for a response…',
    ...
    'chat.cooldown': 'Too many messages, wait {secs}s',
    'chat.cooldownStart': 'Too many messages in a row, wait 10s',
    'chat.dayToday': 'Today',
    'chat.dayYesterday': 'Yesterday',
    'chat.dayAgo': '{n} days ago',
    ...
    'lobby.disqualified': 'DISQUALIFIED',
    ...
    'lobby.globoretoWip': 'Group GlobeQuiz: under construction',
    'lobby.syncTitle': 'Loading match...',
    'lobby.confirmSwitchRoom': "If you join another group, you'll leave this one. Are you sure?",
    'lobby.confirmLeaveHost': 'Are you sure you want to leave? The host role will pass to another member.',
    'lobby.back': '← Back', 'lobby.gqRounds': 'Match rounds', 'lobby.gqTurnTime': 'Response time',
    'lobby.gqSpeedName': 'Real Time', 'lobby.gqTurnsName': 'Turn-Based',
    'lobby.gqInfoRounds': 'Rounds: {n}', 'lobby.gqInfoTurnTime': 'Time: {n}s',
    ...
    'top1Popup.title': "You're the new Top 1!",
    'top1Popup.desc': "You've beaten every player on myGeoChallenge. As a reward, we're gifting you an exclusive frame you can use while you hold first place:",
    'top1Popup.itemFrame': 'Frame',
    'top1Lost.title': 'You lost Top 1',
    'top1Lost.desc': "Another player passed you on the ranking. Keep playing to reclaim first place — the frame comes back once you do.",
    // Account
    'nav.account': 'Account',
